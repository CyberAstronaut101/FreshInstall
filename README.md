...
`curl -sL https://raw.github.com/CyberAstronaut101/FreshInstall/master/setup-kali.sh | sudo bash`

I also dabble a bit in **Parrot OS**. I've since created a similar bootstrap for it as well:

`curl -sL https://raw.github.com/CyberAstronaut101/FreshInstall/master/setup-parrot.sh | sudo bash`
